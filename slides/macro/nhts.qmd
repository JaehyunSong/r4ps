...
* 一般的な統計的仮説検定の場合、仮説を直接検証することはしない（できない）
...
ci95_df |>
  ...
  annotate("text", x =  3, y = 0.1, size = 4,
           label = "α / 2") +
  annotate("segment", x = -3, y = 0.065, xend = -2.1, yend = 0.0176,
...
ci95_df |>
  ...
  annotate("text", x =  3, y = 0.1, size = 4,
           label = "p / 2") +
  annotate("segment", x = -2.85, y = 0.1, xend = -1.4, yend = 0.1,
           arrow = arrow(length = unit(0.1, units = "inch"), 
                         type = "closed")) +
  annotate("segment", x = 2.85, y = 0.1, xend = 1.4, yend = 0.1,
               arrow = arrow(length = unit(0.1, units = "inch"), 
...
ci95_df |>
  ...
  annotate("text", x =  3, y = 0.1, size = 4,
           label = "p /2") +
  annotate("segment", x = -2.85, y = 0.1, xend = -2.1, yend = 0.017,
           arrow = arrow(length = unit(0.1, units = "inch"), 
                         type = "closed")) +
  annotate("segment", x = 2.85, y = 0.1, xend = 2.1, yend = 0.017,
           arrow = arrow(length = unit(0.1, units = "inch"), 
...
ci95_df |>
  ...
  annotate("text", x =  3, y = 0.1, size = 4,
           label = "p / 2") +
  annotate("segment", x = -2.85, y = 0.1, xend = -1.2, yend = 0.1,
           arrow = arrow(length = unit(0.1, units = "inch"), 
                         type = "closed")) +
  annotate("segment", x = 2.85, y = 0.1, xend = 1.2, yend = 0.1,
           arrow = arrow(length = unit(0.1, units = "inch"), 
...
ci95_df |>
  ...
  annotate("segment", x = -1.96, y = 0.3, xend = -4, yend = 0.3,
               arrow = arrow(length = unit(0.1, units = "inch"), 
                             type = "closed")) +
  annotate("segment", x = 1.96, y = 0.3, xend = 4, yend = 0.3,
               arrow = arrow(length = unit(0.1, units = "inch"), 
                             type = "closed")) +
  annotate("segment", x = -1.96, y = 0.2, xend = 1.96, yend = 0.2,
               arrow = arrow(length = unit(0.1, units = "inch"), 
...
ci95_df |>
  ...
  annotate("text", x = 0, y = 0.22, size = 4, label = "受容域") +
  labs(y = "確率密度", x = "T統計量") +
  scale_x_continuous(breaks = c(-1.96, -0.8224918, 0, 1.96),
                     labels = c("下側臨界値\n-1.96", "検定統計量\n-0.822", 
                                "0", "上側臨界値\n1.96")) +
  theme_bw(base_size = 14) +
  theme(panel.grid.major.x = element_blank(),
