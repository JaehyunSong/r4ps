...
* 本講義のサポートページを参照
   * Rの使い方の「[ファイル管理術](https://www.jaysong.net/r4ps/intro/filesystem.html){target="_blank"}」、「[プロジェクト管理](https://www.jaysong.net/r4ps/intro/project.html){target="_blank"}」、「[ファイル管理](https://www.jaysong.net/r4ps/intro/file.html){target="_blank"}」すべてを読むこと
