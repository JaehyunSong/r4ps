...
tibble(id      = 1:10,
       ...
       hdi     = c(0.912, 0.914, 0.917, 0.918, 0.920,
                   0.921, 0.922, 0.922, 0.922, 0.921)) |> 
  gt() |> 
...
数字は各項目を.<ruby>識別<rt>・・</rt></ruby>するものであり、**数字として意味を持たない**
