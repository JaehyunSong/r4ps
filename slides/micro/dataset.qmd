...
* **次回（5月23日）までもう一度R/RStudioの導入・設定**を行う。
   * サポートページの「Rの使い方」から[Rの導入](https://www.jaysong.net/r4ps/intro/install.html){target="_blank"}と[RStudioの設定](https://www.jaysong.net/r4ps/intro/rstudio.html){target="_blank"}を見ながら導入・設定を済ませること。
