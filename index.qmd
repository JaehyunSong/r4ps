...
<center><a href="https://jupyter.cs.rcos.nii.ac.jp/" class="btn btn-info btn-lg" target="_blank" role="button"><i class="bi bi-terminal"></i>&nbsp;&nbsp;&nbsp;JDCat分析ツールの起動</a><br/><span style="font-size:0.75em">（はじめての方は「[Rの導入](intro/install.qmd)」を参照し、まず分析環境を作成してください。）</span></center>
