...
* 詳細は`?modelplot`か[公式ページ](https://modelsummary.com/vignettes/modelplot.html)で確認すること。他にも{[coefplot](https://cran.r-project.org/web/packages/coefplot/index.html)}も人気[^coefplotbl]
